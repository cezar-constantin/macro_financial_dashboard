...
const RO = {
  ...
  "r.hero.mip": "Praguri MIP depășite",
  "home.risks": "Riscuri semnalate",
...
const EN = {
  ...
  "r.hero.mip": "MIP thresholds breached",
  "home.risks": "Risks flagged",
...
export const IND = {
  ...
  credit_gdp_a: { ro: "Datoria sectorului privat (consolidată)", en: "Private sector debt (consolidated)", u: "% PIB", dec: 1, good: 0 },
  credit_flow_a: { ro: "Fluxul de credit către sectorul privat", en: "Private sector credit flow", u: "% PIB", dec: 1, good: 0 },
